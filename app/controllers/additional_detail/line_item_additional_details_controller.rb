class AdditionalDetail::LineItemAdditionalDetailsController < ApplicationController
  ...
  def show
     render :json => @line_item_additional_detail.to_json(:root => false, :methods => [:additional_detail_breadcrumb, :form_data_hash, :additional_detail_schema_hash, :additional_detail_form_array])
  end
