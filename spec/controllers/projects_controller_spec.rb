...
describe ProjectsController do
  ...
  describe 'GET new' do
    it 'should set service_request' do
      ...
      get :new, { :id => service_request.id, :format => :js }.with_indifferent_access
  ...
  describe 'GET create' do
    ...
    it 'should create a project with the given parameters' do
      session[:service_request_id] = service_request.id
      get :create, { :id => service_request.id, :format => :js, :project => { :title => 'this is the title', :funding_status => 'not in a million years' } }.with_indifferent_access
