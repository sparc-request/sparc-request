...
ActiveRecord::Schema.define(version: 2018_10_08_141541) do
  ...
  create_table "lookups", id: :bigint, default: nil, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.integer "new_id"
    t.string "old_id"
  end
  ...
  create_table "toast_messages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.bigint "from"
    t.bigint "to"
  ...
  create_table "versions", id: :bigint, default: nil, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
