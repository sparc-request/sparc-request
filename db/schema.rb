...
ActiveRecord::Schema.define(version: 2020_08_14_162116) do
  ...
  create_table "oauth_access_requests", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "oncore_records", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "protocol_id"
