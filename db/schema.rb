...
ActiveRecord::Schema.define(version: 2024_09_04_154310) do
  ...
  create_table "additional_funding_sources", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin", force: :cascade do |t|
