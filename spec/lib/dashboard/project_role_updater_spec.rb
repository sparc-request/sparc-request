...
RSpec.describe Dashboard::ProjectRoleUpdater do
  ...
  describe "#update" do
    context "params[:project_role] describes a valid ProjectRole" do
      it "should update ProjectRole from params[:id] with params[:project_role]" do
        ...
        builder = Dashboard::ProjectRoleUpdater.new(id: project_role.id, project_role: { role: "not-important" })
        builder.update
    ...
    context "changing role to 'primary-pi'" do
      it "should change current primary pi to a general-access-user" do
        ...
        builder = Dashboard::ProjectRoleUpdater.new(id: project_role.id, project_role: { role: "primary-pi" })
        builder.update
  ...
  describe "#protocol_role" do
    it "should return updated ProjectRole, regardless of validity" do
      ...
      builder = Dashboard::ProjectRoleUpdater.new(id: project_role.id, project_role: { role: nil })
      builder.update

      expect(builder.protocol_role.role).to eq(nil)
    end
  end
  ...
  describe "#successful?" do
    ...
    context "update resulted in invalid ProjectRole" do
      it "should return false" do
        ...
        expect(builder.successful?).to eq(false)
      end
    end
    ...
    context "update resulted in valid ProjectRole" do
      it "should return true" do
        ...
        expect(builder.successful?).to eq(true)
      end
    end
  end
end
