class AddDeletedAtToAll < ActiveRecord::Migration
  def change
    ...
    add_column :human_subjects           , :deleted_at, :datetime
    add_column :identities               , :deleted_at, :datetime
    add_column :impact_areas             , :deleted_at, :datetime
    add_column :investigational_products , :deleted_at, :datetime
    add_column :ip_patents               , :deleted_at, :datetime
    ...
    add_column :research_types           , :deleted_at, :datetime
    ...
    add_column :vertebrate_animals       , :deleted_at, :datetime
