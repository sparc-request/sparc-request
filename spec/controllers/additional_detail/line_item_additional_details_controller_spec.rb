  ...
  describe 'authenticated identity' do
    ...
    describe 'is a project team member with "approve" rights and, thus, has access to' do
      ...
      it 'view a line_item_additional_detail' do
        ...
        expect(response.body).to eq(@line_item_additional_detail.to_json(:root => false, :except => [:created_at, :updated_at], :methods => [:additional_detail_description, :additional_detail_breadcrumb, :form_data_hash, :additional_detail_schema_hash, :additional_detail_form_array]))
      end
