...
ActiveRecord::Schema.define(version: 20170731165230) do
  ...
  create_table "admin_rates", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "approvals", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "arms", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
  ...
  create_table "associated_surveys", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "available_statuses", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "catalog_managers", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "identity_id"
    t.integer "organization_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "charges", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "service_request_id"
  ...
  create_table "clinical_providers", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "identity_id"
    t.integer "organization_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "cover_letters", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text "content"
    t.integer "sub_service_request_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "epic_queue_records", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
    t.string "status"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "epic_queues", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer "identity_id"
  ...
  create_table "epic_rights", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "excluded_funding_sources", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "fulfillments", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "line_item_id"
    t.string "timeframe"
    t.string "time"
    t.datetime "date"
  ...
  create_table "human_subjects_info", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
    t.string "hr_number"
    t.string "pro_number"
  ...
  create_table "impact_areas", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "investigational_products_info", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
    t.string "ind_number"
  ...
  create_table "ip_patents_info", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
  ...
  create_table "item_options", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "content"
  ...
  create_table "line_items_visits", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "arm_id"
    t.integer "line_item_id"
  ...
  create_table "lookups", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "new_id"
    t.string "old_id"
  end
  ...
  create_table "past_statuses", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "sub_service_request_id"
    t.string "status"
    t.datetime "date"
    t.datetime "created_at"
  ...
  create_table "past_subsidies", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "sub_service_request_id"
  ...
  create_table "payment_uploads", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "pricing_maps", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "service_id"
    t.string "unit_type"
  ...
  create_table "pricing_setups", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "organization_id"
    t.date "display_date"
    t.date "effective_date"
  ...
  create_table "professional_organizations", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text "name"
    t.string "org_type"
    t.integer "parent_id"
  end

  create_table "project_roles", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
    t.integer "identity_id"
  ...
  create_table "protocol_filters", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "identity_id"
  ...
  create_table "question_responses", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "question_id"
  ...
  create_table "questionnaire_responses", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "quick_questions", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "to"
    t.string "from"
    t.text "body"
    t.datetime "created_at"
  ...
  create_table "research_types_info", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
  ...
  create_table "revenue_code_ranges", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "from"
    t.integer "to"
  ...
  create_table "service_providers", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "identity_id"
    t.integer "organization_id"
    t.integer "service_id"
  ...
  create_table "service_relations", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "service_id"
  ...
  create_table "service_requests", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
    t.string "status"
    t.boolean "approved"
  ...
  create_table "study_phases", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "order"
    t.string "phase"
  ...
  create_table "study_type_answers", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
  ...
  create_table "study_type_question_groups", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "version"
    t.boolean "active", default: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "study_type_questions", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "order"
    t.text "question"
  ...
  create_table "study_types", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "sub_service_requests", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "service_request_id"
    t.integer "organization_id"
    t.integer "owner_id"
    t.string "ssr_id"
  ...
  create_table "submission_emails", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "organization_id"
    t.string "email"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "subsidies", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.datetime "deleted_at"
  ...
  create_table "subsidy_maps", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "organization_id"
  ...
  create_table "super_users", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "identity_id"
    t.integer "organization_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "toast_messages", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "from"
    t.integer "to"
  ...
  create_table "tokens", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "service_request_id"
    t.integer "identity_id"
    t.string "token"
    t.datetime "created_at"
  ...
  create_table "vertebrate_animals_info", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "protocol_id"
  ...
  create_table "visit_groups", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
    t.integer "arm_id"
    t.datetime "created_at"
    t.datetime "updated_at"
