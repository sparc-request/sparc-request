module CapybaraProper
    ...
    class SparcTester
        ...
        def initialize(browserReference)
            @page = browserReference
        end
        ...
        def submitServiceRequest()
            ...
            # sleep 300
            if have_xpath("//div[@id='ui-accordion-institution_accordion-panel-0' and @display='none']//a[text()='South Carolina Clinical and Translational Institute (SCTR)']") then
