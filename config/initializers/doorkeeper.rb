...
Doorkeeper.configure do
  ...
  resource_owner_authenticator do
    ...
    current_identity || warden.authenticate!(scope: :identity)
  end
  ...
  admin_authenticator do
    ...
    if current_identity
      head :forbidden unless current_identity.is_site_admin?
    else
  ...
  #
  access_token_class "Doorkeeper::AccessTokenCustom"
  # access_grant_class "Doorkeeper::AccessGrant"
  application_class "Doorkeeper::ApplicationCustom"
  #
  ...
  #
  base_controller 'Admin::ApplicationController'
