...
if "<%= @errors %>" == ""
  ...
  $("#pp_max_total_direct_cost").html("<%= dispaly_max_total_direct_cost_per_patient(@service_request) %>")
  $("#pp_max_total_indirect_cost").html("<%= dispaly_max_total_indirect_cost_per_patient(@service_request) %>")
  $("#pp_max_total").html("<%= dispaly_max_total_cost_per_patient(@service_request) %>")

  # Display for all line items total direct, indirect, and total costs per study
  $("#pp_total_direct_cost").html("<%= dispaly_total_direct_cost_per_study_pppvs(@service_request) %>")
  $("#pp_total_indirect_cost").html("<%= dispaly_total_indirect_cost_per_study_pppvs(@service_request) %>")
  $("#pp_total_cost").html("<%= dispaly_total_cost_per_study_pppvs(@service_request) %>")
