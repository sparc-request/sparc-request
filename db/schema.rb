...
ActiveRecord::Schema.define(version: 2018_06_13_141159) do
  ...
  create_table "admin_rates", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
    ...
    t.index ["protocol_id"], name: "index_admin_rates_on_protocol_id"
    t.index ["service_id"], name: "index_admin_rates_on_service_id"
  end
  ...
  add_foreign_key "admin_rates", "protocols"
  add_foreign_key "admin_rates", "services"
