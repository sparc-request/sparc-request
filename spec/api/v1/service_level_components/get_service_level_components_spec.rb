...
RSpec.describe 'SPARCCWF::APIv1', type: :request do
  ...
  describe 'GET /v1/service_level_components.json' do
    ...
    before { FactoryGirl.create(:service_with_service_level_components) }

    context 'response params' do

      before { cwf_sends_api_get_request_for_resources('service_level_components', 'shallow') }
    ...
    context 'request for :full records' do
      ...
      before { cwf_sends_api_get_request_for_resources('service_level_components', 'full') }
    ...
    context 'request for :full_with_shallow_reflections records' do
      ...
      before { cwf_sends_api_get_request_for_resources('service_level_components', 'full_with_shallow_reflections') }
